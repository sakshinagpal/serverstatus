package myngconnect_server_status.qa1;
...
@RunWith(Parameterized.class)
	public class Test_Health_Check_QA1 extends global{ 
	String s = "fasle";  
	private String testEnv;
	private RemoteWebDriver driver = null;
	public Test_Health_Check_QA1(String testEnv){
...
CSVHandler login_details = new CSVHandler("src/test/resources/login_health_check_qa1.csv");
